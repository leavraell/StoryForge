  ...
  return (
    ...
    >
      <RadioPrimitive.Indicator
        className="before:bg-primary-foreground data-checked:bg-primary absolute -inset-px flex size-4.5 items-center justify-center before:size-2 data-unchecked:hidden sm:size-4 sm:before:size-1.5"
